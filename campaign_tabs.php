  ...
  <div class="horizontal-tabs">
    <ul class="nav nav-tabs no-margin project-tabs nav-tabs-horizontal" role="tablist">
        ...
        foreach($tabs as $key => $tab){
            ...
            ?>
            <li class="<?php if($key == 'campaign_overview' && !$this->input->get('group')){echo 'active ';} ?>project_tab_<?php echo $key; ?><?php if($dropdown){echo ' nav-tabs-submenu-parent';} ?>">
                <a
                ...
                <?php if($dropdown){ ?>
                    ...
                    href="<?php echo admin_url('campaigns/view/'.$campaign->id.'?group='.$key); ?>"
                    <?php } ?>>
